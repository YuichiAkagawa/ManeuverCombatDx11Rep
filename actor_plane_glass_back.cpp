...
ActorPlaneGlassBack::ActorPlaneGlassBack(ActorManager*  pActorManager) : ActorHierarchy(pActorManager)
{
	name_ = ActorManager::NAME_PLANE_GLASS_BACK;
	tag_ = ActorManager::TAG_PLANE;
	layer_ = ActorManager::LAYER_GLASS;
}

ActorPlaneGlassBack::~ActorPlaneGlassBack()
{

}

bool ActorPlaneGlassBack::Init()
{
	nameUnique_ = "ActorPlaneGlassBack" + std::to_string(number_);
...
void ActorPlaneGlassBack::Uninit()
{

}

void ActorPlaneGlassBack::Update()
{
	ReflectionMatrix();
}

void ActorPlaneGlassBack::Stats()
{
	ActorHierarchy::Stats();
}

void ActorPlaneGlassBack::Draw()
{
	{
		//アルファブレンド有効
		...
		//モデル描画
		pModelManager_->GetInstance(ModelManager::HORNET_GLASS_BACK)->Draw();
