//**-------------------------------------------------------**
//**
//**               actor_plane_elevator_right.cpp
...
ActorPlaneElevatorRight::ActorPlaneElevatorRight(ActorManager* pActorManager) : ActorHierarchy(pActorManager)
{
	name_ = ActorManager::NAME_PLANE_ELEVATOR_RIGHT;
	tag_ = ActorManager::TAG_PLANE;
	layer_ = ActorManager::LAYER_PLANE;
}

ActorPlaneElevatorRight::~ActorPlaneElevatorRight()
{

}

bool ActorPlaneElevatorRight::Init()
{
	nameUnique_ = "ActorPlaneElevatorRight" + std::to_string(number_);
...
void ActorPlaneElevatorRight::Uninit()
{

}

void ActorPlaneElevatorRight::Update()
{
	ReflectionMatrix();
}

void ActorPlaneElevatorRight::Stats()
{
	ActorHierarchy::Stats();
}

void ActorPlaneElevatorRight::Draw()
{
	{
		//コンスタントバッファ作成
	...
	//モデル描画
	pModelManager_->GetInstance(ModelManager::HORNET_ELEVATOR_RIGHT)->Draw();
}
