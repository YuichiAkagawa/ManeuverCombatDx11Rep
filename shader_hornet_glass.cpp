...
static const std::string FILE_NAME = "hornet_glass.hlsl";

bool ShaderHornetGlass::Init()
{
	fileName_ = FILE_NAME;
...
bool ShaderHornetGlass::InputLayout()
{
	//インプットレイアウト作成
...
bool ShaderHornetGlass::CreateConstantBuffer()
{
