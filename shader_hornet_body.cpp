...
static const std::string FILE_NAME = "hornet_body.hlsl";

bool ShaderHornetBody::Init()
{
	fileName_ = FILE_NAME;
...
bool ShaderHornetBody::InputLayout()
{
	//インプットレイアウト作成
...
bool ShaderHornetBody::CreateConstantBuffer()
{
